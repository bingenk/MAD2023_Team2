    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (expenseModel != null) {
                ...
                binding.tSubmit.setText("Update");
...
//    finish();
    ...
    private void updateExpense() {
        ...
        ExpenseModel model = new ExpenseModel(expenseId, note, category, type, Double.parseDouble(amount), expenseModel.getTime());
        ...
        // Use the new ExpenseModel object (model) to update the expense
