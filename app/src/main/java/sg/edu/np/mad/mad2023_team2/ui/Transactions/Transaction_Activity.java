...
import sg.edu.np.mad.mad2023_team2.ui.Currency_Converter.ExpenseAdapter;
...
Intent intent;
    ...
    private void retrieveAllExpenses() {
        ...
        expensesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                HashMap<String, Long> categoryTotals = calculateCategoryTotals();
    ...
    private void setUpGraph(HashMap<String, Long> categoryTotals) {
        List<PieEntry> pieEntryList = new ArrayList<>();
        List<Integer> colorlist = new ArrayList<>();

        for (String category : categoryTotals.keySet()) {
            long totalAmount = (long) (categoryTotals.get(category)*conversion_Rate);
            pieEntryList.add(new PieEntry(totalAmount, category));
   ...
   startActivity(intent);
    ...
    private HashMap<String, Long> calculateCategoryTotals() {
        ...
        for (ExpenseModel expense : expenseList) {
            ...
            if (categoryTotals.containsKey(category)) {
                ...
                long totalAmount = categoryTotals.get(category) + amount;
        ...
        for (String category : categoryTotals.keySet()) {
            long totalAmount = categoryTotals.get(category);
