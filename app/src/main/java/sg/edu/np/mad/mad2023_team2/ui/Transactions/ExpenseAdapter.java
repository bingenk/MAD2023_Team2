...
public class ExpenseAdapter extends RecyclerView.Adapter<ExpenseAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String formattedDate = dateFormat.format(expenseModel.getTime());
        holder.date.setText(formattedDate); // Fix the typo and use setText() to set the date


         double result=expenseModel.getAmount()*conversion_Rate;
        DecimalFormat decimalFormat = new DecimalFormat("#.###");
        String roundedResult = decimalFormat.format(result);

         holder.amount.setText(roundedResult);
